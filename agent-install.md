...
Windows 使用 `zcode-keysmith-win.py`（macOS 版逻辑的 Windows 移植，含 stdio 管道修复）：

```text
请使用 https://github.com/wdq1314070-bit/zcode-keysmith 帮我安装 ZCode App 的 managed true system-role entrypoint（Windows 版）。
